...
public class TelaLaLiga extends javax.swing.JPanel {
    String nome, email;
    ...
    public TelaLaLiga(String nome, String email, BackgroundMusic bck, boolean mscOn) {
        initComponents();
        backgroundMusic = bck;
    ...
    private void initComponents() {
        ...
        add(SOM, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 210, 90, 60));
        ...
        add(BT_Voltar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 200, 70));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/WallPaperLaLiga.png"))); // NOI18N
