...
public class TelaPremier extends javax.swing.JPanel {
    String nome, email;
    ...
    public TelaPremier(String nome, String email, BackgroundMusic bck, boolean mscOn) {
        initComponents();
        backgroundMusic = bck;
    ...
    private void initComponents() {
        ...
        add(SOM, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 240, 90, 60));
        ...
        add(BT_Voltar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 210, 80));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/WallPaperPremier.png"))); // NOI18N
